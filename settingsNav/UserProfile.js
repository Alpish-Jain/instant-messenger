...
<TouchableOpacity onPress={onShowHideModal} style={styles.closeButtonStyle}>
  ...
  showEditButton
  containerStyle={{marginLeft:100,marginTop:30}}
/>
                    ...
                    <TouchableOpacity onPress={()=>{
                        ...
                        <ListItem>
                            ...
                            <ListItem.Subtitle>{item.title}</ListItem.Subtitle>
                                <ListItem.Title style={styles.titleStyle}>{item.Subtitle}</ListItem.Title>
                            </ListItem.Content>
                            <Ionicons name='md-pencil-sharp' size={15} color="black" />
                        </ListItem>
